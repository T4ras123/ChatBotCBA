...
async def ask_gpt4o(message: Message):
    ...
    user_language = get_user_language(user_id)  # Функция для получения языка пользователя из БД
    ...
    try:
        ...
        messages_list = [
            ...
            {"role": "system", "content": "Խնդրում ենք օգտատիրոջ հարցման պատասխանը կազմել հետևյալ կանոններին համապատասխան.\n"
                                          ...
                                          "2) Եթե հարցումը **ռուսերեն** է, անկախ այն բանից, թե գրվա�� է ռուսերեն տառերով կամ լատինատառ, ապա պատասխանը տվեք **ռուսերենով**։"},
